...
export default function Signup() {
  ...
  const planLabel = plan === 'pro' ? 'Pro — $49/mo' : 'Starter — $19/mo'
    ...
    <div style={pageStyle}>
      <div style={cardStyle}>
        ...
        <p style={{ fontSize: 14, color: '#666', marginBottom: 20 }}>
          7 days free, then{' '}
          <span style={{ color: '#185FA5', fontWeight: 500 }}>{planLabel}</span>
        </p>
        ...
        <p style={{ fontSize: 12, color: '#999', marginTop: 16, lineHeight: 1.5 }}>
          By creating an account you agree to our Terms of Service. No credit card required during trial.
        </p>
